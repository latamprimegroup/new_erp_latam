...
export const MODULES_ERP: NavItem[] = [
  ...
  },
  {
    ...
    roles: ['ADMIN', 'COMMERCIAL', 'DELIVERER', 'PRODUCER', 'FINANCE', 'MANAGER'],
    icon: 'UserPlus',
    group: 'Comercial',
  },
  {
  ...
  // ── Marketing & Tech ──────────────────────────────────────────────────────
  {
    ...
    roles: ['ADMIN', 'COMMERCIAL', 'FINANCE', 'DELIVERER', 'PRODUCER', 'MANAGER', 'PLUG_PLAY'],
    icon: 'BarChart2',
  ...
  },
  {
    ...
    roles: ['ADMIN', 'PRODUCER', 'FINANCE', 'COMMERCIAL', 'DELIVERER'],
    icon: 'LayoutGrid',
    group: 'Sistema',
  },
  {
