  ...
  return (
    <div>
      <div className="flex gap-4 items-center mb-6">
        <Link href="/dashboard/producao" className="text-gray-500 hover:text-gray-700 dark:hover:text-gray-300">← Produção</Link>
        <h1 className="heading-1">Saldo e Saque</h1>
      </div>
      <p className="text-gray-600 dark:text-gray-400 text-sm mb-6">
        Salário base + valor por conta aprovada + bônus de meta. Solicite saque quando houver saldo disponível após
        fechamento mensal.
      </p>
      <SaldoSaqueClient />
    </div>
